import { ElegantCards } from "@/components/elegant-cards"
import { Navigation } from "@/components/navigation"

export default function ElegantCardsPage() {
  return (
      ...
      <div className="pt-20 pb-8 px-4 flex items-center justify-center">
        <div className="w-full max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-lg">Interface utilisateur soignée avec interactions fluides</p>
          </div>
          <ElegantCards />
        </div>
      </div>
